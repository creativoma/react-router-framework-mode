...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Login - IA Tooling" },
    { name: "description", content: "Sign in to your IA Tooling account to access all features." },
  ];
}

// Action para manejar el login (React Router Framework Mode)
